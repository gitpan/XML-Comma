...
# delete bl2 -- the file should go away
$blob_location = $doc->element('bl2')->get_location();
print "ok 14\n"  if  -r $blob_location;
$doc->delete_element ( $doc->element('bl2') );
print "ok 15\n"  if  ! -r $blob_location;
# put things back the way they were
$doc->element('bl2')->set("first set for bl2");
print "ok 16\n"  if  -r $doc->element('bl2')->get_location();
$doc->store(keep_open=>1);
